    ...
    { 
        public static void main(String args[])   
            {  
                ...
                System.out.println("\t\t\t\t\t "+"  "+"   HOTEL AANAI MUGAN");  
                System.out.println("\t\t\t\t\t        GEMMANGKUPPAM");  
                System.out.println("\t\t\t\t\t"  +"    " +"OPPOSITE TO READING ROOM");  
                System.out.println("GSTIN: 03AWBPP8756K592"+"\t\t\t\t\t\t\tContact: (+91) 9025516083");  
                ...
                System.out.println("Date: "+formatter.format(date)+"  "+days[calendar.get(Calendar.DAY_OF_WEEK) - 1]+"\t\t\t\t\t\t (+91) 7010267303");  
                ...
                System.out.println("\t\t\t\t                YOURS FAITHFULLY THIRUNEELAM");
                scan.close();  
            }     
    }  
